...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        topic = pinned if pinned else await ai.detect_topic(user_text, user_id)
...
async def handle_voice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        pinned = db.get_user_topic(user_id)
        topic = pinned if pinned else await ai.detect_topic(text, user_id)
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        pinned = db.get_user_topic(user_id)
        topic = pinned if pinned else await ai.detect_topic(caption, user_id)
        history = db.get_history(user_id, topic)
